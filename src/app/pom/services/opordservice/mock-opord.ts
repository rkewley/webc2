...
export const OLD_FRAGO: FRAGO = {
  commands: [{
      CommandType: "Unit",
      UnitCommand: {
        Receiver: "Squad Leader",
        ScriptName: "Road march",
        Sender: "Squad Leader",
        TacticalActions: [actions],
        UnitName: "1st Squad"
      },
      SingleEntityCommand: undefined,
      SingleEntitySignal: undefined,
      UnitSignal: undefined
    }
  ]
}

export const MOCK_FRAGO:FRAGO =
{
  "commands": [{
    "CommandType": "Unit",
    "UnitCommand": {
      ...
      "TacticalActions": [{
        ...
        "ActionType": "Orient",
        "Orient": {
          "ActionTrigger": {"TriggerType": "CompletionOfPrevious", "OrderOfExecution": 2},
          "OrientationInDegrees": 80
        }
      }],
      "UnitName": "1st Squad"
    }
